...
const CartDetails = () => {
    ...
    return (
        <div className='bgColor' style={{height:"90vh"}}>
            <div className='row justify-content-center m-0 bgColor'>
                        ...
                        <div className="card-body p-0">
                                {
                                    ...
                                    <table className='table cart-table mb-0 table-responsive-sm'>
                                        <thead>
                                            <tr>
                                                <th className='desktop'>Action</th>
                                                <th className='desktop'>Product</th>
                                                <th>Name</th>
                                                    ...
                                                    return (
                                                        <>
                                                            <tr>
                                                                ...
                                                                <td className='desktop'><div className='product-img'><img src={data.imgdata} alt="" /></div></td>
                                                                <td><div className='product-name'><p>{data.dish}</p></div></td>
                                                                <td className='desktop'>{data.price}</td>
                                                                <td>
                                                                    <div className="prdct-qty-container">
                                                                        ...
                                                                        <input type="text" className='qty-input-box qtyDesktop' value={data.qnty} disabled name="" id="" />
                                        ...
                                        <tfoot>
                                            <tr>
                                                <th>&nbsp;</th>
                                                <th className='desktop' colSpan={3}>&nbsp;</th>
